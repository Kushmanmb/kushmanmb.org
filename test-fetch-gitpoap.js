...
async function runTests(runner) {
  ...
  await runner.test('Test 1: Module exports fetchGitPOAPs function', () => {
  ...
  await runner.test('Test 2: fetch-gitpoap.js file exists', () => {
  ...
  await runner.test('Test 3: Module requires ethers.js', () => {
  ...
  await runner.test('Test 4: Module has CLI interface', () => {
  ...
  await runner.test('Test 5: Module validates Ethereum addresses', () => {
  ...
  await runner.test('Test 6: Module uses correct GitPOAP API URL', () => {
  ...
  await runner.test('Test 7: Module has proper error handling', () => {
  ...
  await runner.test('Test 8: Module uses http-utils for requests', () => {
  ...
  await runner.test('Test 9: Module returns structured response', () => {
  ...
  await runner.test('Test 10: Module provides user-friendly console output', () => {
  ...
  await runner.test('Test 11: Module handles 404 responses gracefully', () => {
  ...
  await runner.test('Test 12: Module validates array responses', () => {
...
// Run the test suite
runTestSuite('Testing fetch-gitpoap.js module...', runTests);
